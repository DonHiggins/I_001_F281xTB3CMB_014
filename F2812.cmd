...
//   FLASHC      : origin = 0x3F0000, length = 0x004000     /* on-chip FLASH */
   VEC_FROM_BOOT : origin = 0x3D8000, length = 0x000004     /* 1st 4 words of FLASHC get vector to main prog from bootloader*/
   FLASHCDEFGHIJ   : origin = 0x3D8004, length = 0x01BFFC     /* on-chip FLASH  -- Combined FLASHC to FLASHJ, minus 1st 4 words*/
...
PAGE 1 :   /* Data Memory */
   ...
   EXTRAM      : origin = 0x100000, length = 0x040000     /* external 256K x 16 bit */
}
...
SECTIONS
{
   ...
   bootentry           : > VEC_FROM_BOOT  PAGE = 0

   .cinit              : > FLASHCDEFGHIJ      PAGE = 0
   .pinit              : > FLASHCDEFGHIJ      PAGE = 0
   .text               : > FLASHCDEFGHIJ      PAGE = 0
   codestart           : > BEGIN       PAGE = 0
   ramfuncs            : LOAD = FLASHCDEFGHIJ,
                         RUN = RAML0, 
   ...
   .stack              : > RAMM0       PAGE = 1
   .ebss               : > RAMH0       PAGE = 1   /*  was RAML1 before 7/14/2015 */
   .esysmem            : > RAML1       PAGE = 1   /*  was RAMH0 before 7/14/2015 */
   ...
   .econst             : > FLASHCDEFGHIJ      PAGE = 0
   .switch             : > FLASHCDEFGHIJ      PAGE = 0

   /* Allocate IQ math areas: */
   IQmath              : > FLASHCDEFGHIJ      PAGE = 0                  /* Math Code */
